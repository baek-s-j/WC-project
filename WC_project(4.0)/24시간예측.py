...
total_vars = ["MONTH", "ta", "pv", "td", "m005Te", "m01Te", "m02Te", "m03Te"]
...
for i in range(n_past, len(training_set_scaled) - n_future + 1):
    X.append(training_set_scaled[i - n_past: i, 0: training_set.shape[1]])
    y.append(y_training_set_scaled[i:i + n_future, 0])
...
plt.plot(y_test_inv[20:21].T, label="Actual")
plt.plot(y_pred_inv[20:21].T, label="Predict")
plt.ylabel(output_var)
plt.xlabel("Time")
plt.legend(loc=2, ncol=2, bbox_to_anchor=(0.3, 1.15))
plt.show()
